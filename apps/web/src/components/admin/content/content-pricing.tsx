		...
		<div className="space-y-4">
			<div className="flex items-center justify-between">
				...
				<Button
					className="gap-2"
					onClick={() =>
						navigate({ to: "/admin/content/$id", params: { id: contentId } })
					}
					type="button"
					variant="outline"
				>
			...
			<div className="grid grid-cols-[1fr_320px] items-start gap-6">
				<div className="rounded-xl border bg-card">
					...
					{windows.length === 0 ? (
						...
						windows.map((pw) => (
							<div
								className="grid grid-cols-[1fr_80px_1fr_1fr_80px_auto] items-center gap-4 border-b px-6 py-4 last:border-0 hover:bg-muted/30"
								key={pw.id}
							>
