...
ALTER TABLE "content_category" RENAME TO "course_category";--> statement-breakpoint
ALTER TABLE "content_view" RENAME TO "course_lesson_view";--> statement-breakpoint
ALTER TABLE "course_category" RENAME COLUMN "content_id" TO "course_id";--> statement-breakpoint
ALTER TABLE "course_lesson_view" RENAME COLUMN "content_id" TO "course_lesson_id";--> statement-breakpoint
ALTER TABLE "watch_progress" RENAME COLUMN "content_id" TO "course_lesson_id";--> statement-breakpoint
ALTER TABLE "user_library" DROP CONSTRAINT "userLibrary_userContent_unique";--> statement-breakpoint
ALTER TABLE "course_category" DROP CONSTRAINT "contentCategory_unique";--> statement-breakpoint
ALTER TABLE "watch_progress" DROP CONSTRAINT "watchProgress_userContent_unique";--> statement-breakpoint
ALTER TABLE "order" DROP CONSTRAINT "order_content_id_content_id_fk";
--> statement-breakpoint
ALTER TABLE "order" DROP CONSTRAINT "order_playlist_id_playlist_id_fk";
--> statement-breakpoint
ALTER TABLE "user_library" DROP CONSTRAINT "user_library_content_id_content_id_fk";
--> statement-breakpoint
ALTER TABLE "user_library" DROP CONSTRAINT "user_library_playlist_id_playlist_id_fk";
--> statement-breakpoint
ALTER TABLE "course_category" DROP CONSTRAINT "content_category_content_id_content_id_fk";
--> statement-breakpoint
ALTER TABLE "course_category" DROP CONSTRAINT "content_category_category_id_category_id_fk";
--> statement-breakpoint
ALTER TABLE "course_lesson_view" DROP CONSTRAINT "content_view_content_id_content_id_fk";
--> statement-breakpoint
ALTER TABLE "course_lesson_view" DROP CONSTRAINT "content_view_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "course_lesson_view" DROP CONSTRAINT "content_view_session_id_session_id_fk";
--> statement-breakpoint
ALTER TABLE "watch_progress" DROP CONSTRAINT "watch_progress_content_id_content_id_fk";
--> statement-breakpoint
ALTER TABLE "watch_progress" DROP CONSTRAINT "watch_progress_playlist_id_playlist_id_fk";
--> statement-breakpoint
...
DROP INDEX "contentCategory_contentId_idx";--> statement-breakpoint
DROP INDEX "contentCategory_categoryId_idx";--> statement-breakpoint
DROP INDEX "contentView_contentId_idx";--> statement-breakpoint
DROP INDEX "contentView_userId_idx";--> statement-breakpoint
DROP INDEX "contentView_viewedAt_idx";--> statement-breakpoint
DROP INDEX "contentView_sessionId_idx";--> statement-breakpoint
...
ALTER TABLE "course_category" ADD CONSTRAINT "courseCategory_unique" UNIQUE("course_id","category_id");--> statement-breakpoint
